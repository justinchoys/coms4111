...
\copy agent_employed(agentID, name, licenseNo, phoneNo, rating, agencyID, since) from 'agent_employed.csv' delimiter ',' csv header;
...
\copy property(propertyID, address, yearBuilt, type, size, baNo, brNo) from 'property.csv' delimiter ',' csv header;
...
\copy borrows(buyerID, bAge, dealDate, propertyID, lenderID, mortgageID, term, amount, interestRate) from 'borrows.csv' delimiter ',' csv header;